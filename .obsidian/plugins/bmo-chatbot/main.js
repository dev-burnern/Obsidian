...
// src/constants.ts
var DEFAULT_MODEL = "xionic-ko-llama-3-70b";
var SIONIC_API_KEY = "934c4bbc-c384-4bea-af82-1450d7f8128d";
var SIONIC_API_URL = "http://sionic.chat:8001/v1";
...
async function fetchSionicAIAPIResponseStream(plugin, settings, index) {
  var _a2, _b;
  const openai = new openai_default({
